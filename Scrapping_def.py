...
def get_chrome_driver(user, password):
    ...
    chrome_driver_path = "//FRSHARES0479.france.intra.corp/Corporate_Remarketing/Remarketing_Data_Intelligence/200_MARKET_INTELLIGENCE/chromedriver.exe"
    service_args = [
        '--proxy=http://{}:{}@frmarprx0101.france.intra.corp:8090'.format(user, password),
        '--proxy-type=https']
    options = Options()
